...
<jsp:useBean id="Usuario" type="com.example.lab9_20204205.model.beans.Usuario" scope="request"/>
<jsp:useBean id="rectorBuscado" type="java.util.ArrayList<com.example.lab9_20204205.model.beans.Usuario>"
             scope="request"/>
<!DOCTYPE html>
<html>
<head>
